terraform {
    source = "git::https://github.com/swapnilbharshankar/infrastructureascode-terraform//azure/virtual-machine?ref=main"
}
...
inputs = {
    virtual_machines = include.root.locals.env_vars.virtual_machines
}
